    ...
    <section className={styles.dashboard}>
      <div className={`container ${styles.dashboard__container}`}>
        ...
        <div className={styles.dashboard__about}>
          ...
          Компания Аквалайф занимается продажей сантехнического оборудования высокого качества. 
          Аквалайф работает с известными производителями и предлагает своим клиентам широкий выбор современных и стильных решений для обустройства сантехнических помещений.
          </p>
        </div>
      </div>
    </section>
